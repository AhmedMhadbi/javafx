...
public class Cartebancaire {
    ...
    int id, compte_id, is_frozen,etablissement_id ;
    ...
    public Cartebancaire(int compte_id, int is_frozen, int etablissement_id, String num_carte, String cvv, LocalDate date_exp) {
    ...
    public Cartebancaire(int id, int compte_id, int is_frozen, int etablissement_id, String num_carte, String cvv, LocalDate date_exp) {
        this.id = id;
        this.compte_id = compte_id;
        this.is_frozen = is_frozen;
        this.etablissement_id = etablissement_id;
