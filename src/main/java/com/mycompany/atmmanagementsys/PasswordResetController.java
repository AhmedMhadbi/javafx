        ...
        if (cusid.getText().isEmpty()) {
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    PreparedStatement pss = con.prepareStatement("UPDATE user SET password = ? WHERE id = '" + cusid.getText() + "'");
                    pss.setString(1, Integer.toString(pass));
                    int i = pss.executeUpdate();
                    if (i > 0) {
                        confirmation.setText("A New Random Password Is Set To This ID"+"\n");
                        final String username = "firstwarrior92.jebali@gmail.com"; // you have to change your security level
                        final String password = "wjig nnhj pmdq fhrj";
                        ...
                        try {
                            ...
                            message.setFrom(new InternetAddress("firstwarrior92.jebali@gmail.com"));
